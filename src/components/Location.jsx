        ...
        <section>
            <form className='flex justify-center'>
                <div className='inline-block relative'>
                    <input type="text" value={locationNameInput} placeholder='Type a Location name...' className='border-2 border-[#893446] rounded-3xl bg-[#fff] p-2 placeholder:p-2 placeholder:text-center focus:outline-none text-center text-black w-[400px] h-[40px]' onChange={onInputChange} onFocus={onInputChange}/>
